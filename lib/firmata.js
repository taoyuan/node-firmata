...
Board.prototype.reportAnalogPin = function(pin, value) {
  ...
  var index = isAnalogIndex ? pin : this.analogPins[pin];
  ...
  if (value === 0 || value === 1) {
    if (this.pins[index].report !== value) {
      this.pins[index].report = value;

      if (this.reporting.indexOf(pin) === -1) {
...
Board.prototype.reportDigitalPin = function(pin, value) {
  ...
  if (value === 0 || value === 1) {
    ...
    if (this.reporting.indexOf(port) === -1) {
